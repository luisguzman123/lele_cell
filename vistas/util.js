...
function mensaje_confirmacion(mensaje, titulo) {
  //    var con = `<div class='modal fade' tabindex='-1'
  //role='dialog' aria-labelledby='mySmallModalLabel' aria-hidden='true' id='modal-confirmacion'>
  ...
  //  </div>
  //</div>`;
  var con = `<div class="modal fade" id="modalconfirma" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">${titulo}<span></span></h5>
                ...
                <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger" id='modal-btn-si'>Si</button>
                    
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal" id='modal-btn-no'>Cancelar</button>
                </div>
            </div>
        </div>
    </div>`;
  $("contenedor-modal").html(con);
